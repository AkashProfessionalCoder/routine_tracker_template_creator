            ...
            <header className="bg-white shadow-sm sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1
                            onClick={() => navigate('/tracker')}
                            className="text-2xl font-bold text-gray-900 tracking-tight cursor-pointer hover:text-blue-600 transition-colors"
                        >
                            Routine Tracker
                        </h1>
                    </div>
                        ...
                        {showNavigation && !isSettingsPage && (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors shadow-sm hover:shadow"
                                >
                                    <Settings size={18} />
